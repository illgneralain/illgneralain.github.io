...
function generatePassword() {
    ...
    //// if character type is selected, the array name is stored into group array
    // push function adds a new element to the array 
    ...
    for(let i=0;i<passwordLength;i++){
        ...
        // console.log("The selected Array is the " + selectedCharArray); // checking array chosen
        // console.log("The selected random index is " + randomCharNum); // checking random number generation based on chosen array length 
...
// password is generated, prompts begin once click is done on generate password button 
// THEN the password is either displayed in an alert or written onto the page
